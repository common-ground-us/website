...
/**
 * The full policy search/explore experience. This was the home page (`/`) and
 * will return there at launch. It is currently not mounted on any public route:
 * `/` shows the launch banner and `/search` redirects here-to-be back to `/`.
 */
